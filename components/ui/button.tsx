...
const buttonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap rounded-sm text-sm font-semibold tracking-wide transition-all duration-200 focus-visible:outline-hidden disabled:pointer-events-none disabled:opacity-50 data-[state=loading]:cursor-wait",
  {
    variants: {
      variant: {
        default:
          "relative bg-gradient-to-b from-primary-400 to-primary-600 text-primary-foreground shadow-lg hover:shadow-glow hover:from-primary-300 hover:to-primary-500 active:scale-[0.98] focus-visible:shadow-glow",
        destructive:

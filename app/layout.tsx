  ...
  return (
    <html lang="en" className="dark">
      ...
      <body className="relative z-10">
        ...
        {/* Telegram Bot FAB with electric glow */}
        <a
        ...
        >
          {/* Glow effect */}
          <span className="absolute inset-0 rounded-2xl bg-[#0088cc] opacity-0 blur-xl transition-opacity duration-300 group-hover:opacity-40" />

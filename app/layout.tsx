    ...
    <html lang="en">
      ...
      <body className="font-sans selection:bg-accent selection:text-accent-foreground">
        ...
        <a
          ...
          className="fixed bottom-6 right-6 z-50 flex items-center justify-center p-4 rounded-full bg-[#0088cc] text-white shadow-lg transition-all duration-300 hover:scale-110 hover:shadow-xl focus:outline-none focus:ring-2 focus:ring-[#0088cc] focus:ring-offset-2"

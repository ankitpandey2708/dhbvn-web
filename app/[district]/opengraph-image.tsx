...
import { districtFromSlug, FARIDABAD_ID } from '@/lib/district-slug';

export const runtime = 'edge';
export const size = { width: 1200, height: 630 };
export const contentType = 'image/png';

export const alt = 'DHBVN Power Outage Tracker';
...
export default async function OGImage({ params }: Params) {
  ...
  const name = district && district.id !== FARIDABAD_ID ? district.name : 'Haryana';
